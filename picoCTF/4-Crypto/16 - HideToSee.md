...
### Solución
Aplicamos binwalk para extraer los archivos internos en la foto. 
```
┌──(kali㉿kali)-[~/PICOCTF/hidetosee]
└─$ binwalk -e atbash.jpg          
...
```
Lo desciframos en cyberchef mediante el cifrado atbash.
